...
/**
 * This panel is positioned absolutely and covers the whole client area of the
 * browser. It can be used to disable everything underneath it with appropriate
 * z-index.
 * <p>
 * For instance a dialog can attach it to the root panel during opening, and
 * remove it during closing.
 * <p>
 * CSS:<br>
 * .yanel-GlassPanel
 * 
...
public class GlassPanel extends Composite implements WindowResizeListener {
	...
	public void show() {
		// Override the styles explicitly, because it's needed every time the
		// widget is detached
